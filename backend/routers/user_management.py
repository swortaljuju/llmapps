...
async def signup(signup_user: SignUpUser,
    ...
    existing_user = db.query(User).filter(
        (User.username == signup_user.username) | 
    ...
    redis_client.set(f"verification:{verification_token}", str(new_user.id), ex=ONE_WEEK_IN_SECONDS)
...
async def verify(verification_token: str,
    ...
    redis_client.delete(f"verification:{verification_token}")
